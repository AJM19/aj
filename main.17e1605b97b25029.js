...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;margin-bottom:15px;select{border:1px solid ", ";font-family:Quicksand;font-weight:bold;width:100px;border-radius:5px;}p{margin:0;font-family:Quicksand;font-size:18px;font-weight:bold;color:white;}"], colors.darkBlue);
...
/******/ var __webpack_exports__ = (__webpack_exec__(2031));
/******/ }
]);