...
})(["display:flex;position:absolute;top:", ";left:", ";right:", ";width:45px;height:45px;background:", ";color:white;border-radius:100%;border:none;font-size:30px;font-weight:bold;font-family:Barlow;justify-content:center;align-items:center;box-shadow:1px 1px #ccc6c6;@media (max-width:500px){width:18px;height:18px;font-size:12px;}:hover{color:", ";background:white;border:1px solid ", ";}"], props => props.top, props => props.left, props => props.right, colors.darkBlue, colors.darkBlue, colors.darkBlue);
...
})(["margin:0;display:inline-flex;width:fit-content;font-family:Barlow;font-weight:500;color:", ";font-size:25px;"], props => props.color ? props.color : 'black');
