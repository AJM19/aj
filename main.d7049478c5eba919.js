...
})(["color:", ";width:fit-content;font-family:Quicksand;margin:0;font-weight:800;display:inline-flex;font-size:65px;animation:", " 1s ease-out;@media (max-width:500px){font-size:45px;}"], props => props.color ? props.color : 'black', flyIn);
...
})(["margin:0;display:inline-flex;width:fit-content;font-family:Quicksand;color:", ";font-size:20px;animation:", " 1s ease-out;"], props => props.color ? props.color : 'black', flyIn);
...
})(["margin:0;display:inline-flex;width:fit-content;font-family:Quicksand;color:", ";font-size:15px;font-weight:", ";"], props => props.color ? props.color : 'black', props => props.weight);
...
})(["display:flex;width:fit-content;height:45px;border-radius:25px;color:white;background:", ";justify-content:center;align-items:center;font-family:Quicksand;font-weight:bold;border:1px solid white;padding:15px;font-size:20px;box-shadow:1px 1px #ccc6c6;animation:", " 1s ease-out;:hover{color:", ";background:white;border:1px solid ", ";}"], colors.darkBlue, flyIn, colors.darkBlue, colors.darkBlue);
...
const StyledBar = /*#__PURE__*/styled_components_browser_cjs/* default.div.withConfig */.ZP.div.withConfig({
  ...
  componentId: "sc-3ji5et-0"
})(["display:grid;height:60px;width:100%;background:white;align-items:center;grid-template-columns:1fr 1fr 1fr 5fr;gap:25px;justify-items:end;border-bottom:2px solid ", ";@media (max-width:500px){height:80px;}"], colors.darkBlue);
const StyledLink = /*#__PURE__*/(0,styled_components_browser_cjs/* default */.ZP)(react_router_dom_production_min.Link).withConfig({
  ...
  componentId: "sc-3ji5et-1"
})(["display:flex;width:100%;font-size:22px;color:", ";text-decoration:none;width:fit-content;font-family:Quicksand;margin-left:10px;font-weight:700;"], colors.darkBlue);
...
})(["display:flex;flex-direction:column;height:100vh;overflow:hidden;background:#1b7fcc;"]);
...
const Layout = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(StyledContainer, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_NavBar, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(StyledContent, {
      children: children
    })]
  });
};
...
})(["display:flex;position:relative;flex-direction:column;height:450px;background:white;margin:75px;align-items:center;gap:10px;border-radius:10px;border:1px solid ", ";@media (max-width:800px){margin:40px;}"], colors.darkBlue);
...
})(["display:flex;position:absolute;top:", ";left:", ";right:", ";width:45px;height:45px;background:", ";color:white;border-radius:100%;border:none;font-size:30px;font-weight:bold;font-family:Quicksand;justify-content:center;align-items:center;box-shadow:1px 1px #ccc6c6;@media (max-width:500px){width:18px;height:18px;font-size:12px;}:hover{color:", ";background:white;border:1px solid ", ";}"], props => props.top, props => props.left, props => props.right, colors.darkBlue, colors.darkBlue, colors.darkBlue);
...
})(["color:", ";width:fit-content;font-family:Quicksand;margin:0;font-weight:800;display:inline-flex;font-size:60px;t text-align:center;@media (max-width:500px){font-size:18px;}"], props => props.color ? props.color : 'black');
...
})(["margin:0;display:inline-flex;width:fit-content;font-family:Quicksand;font-weight:500;color:", ";font-size:25px;"], props => props.color ? props.color : 'black');
...
})(["display:flex;position:relative;flex-direction:column;background:white;margin:75px;align-items:center;gap:10px;border-radius:10px;padding:10px 0;border:1px solid ", ";height:175px;justify-content:center;text-align:center;@media (max-width:800px){margin:40px;}"], colors.darkBlue);
...
})(["display:grid;height:70%;width:100%;background:white;grid-template-columns:60% 40%;align-items:center;justify-items:center;margin-bottom:50px;margin-top:50px;overflow-x:auto;@media (max-width:700px){grid-template-columns:1fr;grid-template-rows:1fr 1fr;height:calc(100% + 100px);}"]);
...
})(["height:400px;width:400px;border-radius:100%;align-items:center;justify-content:center;display:flex;border:4px solid #1b7fcc;position:relative;animation:", " 1s ease-out;@media (max-width:800px){height:300px;width:300px;}"], HomePage_popUp);
...
})(["display:flex;width:200px;height:25px;color:black;border-radius:5px;background:#f0f2f5;border:1px solid transparent;padding-left:25px;font-size:12px;font-family:Quicksand;:hover{border:1px solid ", ";}"], colors.darkBlue);
...
const BarChart = ({
  ...
  (0,react.useEffect)(() => {
    ...
    //Value label
    svg.selectAll('text').data(data).join('text').attr('transform', `translate(${margin.left}, 0)`).attr('x', d => xScale(d.x) + xScale.bandwidth() / 2).attr('y', d => yScale(d.y) - 75).text(d => d.y + caption).attr('text-anchor', 'middle').attr('font-size', fontSize).attr('font-weight', '600').style('font-family', 'Quicksand').attr('fill', `${colors.mainBlue}`);

    //Title
    svg.append('text').attr('x', _width / 2).attr('y', margin.top / 2).text(title).style('text-anchor', 'middle').style('font-size', '70px').style('font-weight', '900').style('font-family', 'Quicksand').attr('fill', `${colors.darkBlue}`);

    // Draw x-axis
    svg.append('g').attr('transform', `translate(${margin.right}, ${_height - margin.bottom - 20})`).call(axisBottom(xScale)).selectAll('text').style('font-size', '2rem').attr('font-weight', '800').style('font-family', 'Quicksand');

    // Draw y-axis
    svg.append('g').attr('transform', `translate(${margin.left}, -${margin.top})`).call(axisLeft(yScale).ticks(tick)).selectAll('text').style('font-size', axisFontSize).style('font-family', 'Quicksand');
    ////
...
})(["display:flex;width:100px;height:25px;border-radius:25px;color:white;background:", ";justify-content:center;align-items:center;font-family:Quicksand;font-weight:bold;border:1px solid white;border:1px solid transparent;:hover{color:", ";background:", ";border:1px solid ", ";}", ";"], colors.darkBlue, colors.darkBlue, colors.mainBlue, colors.darkBlue, ({
  isActive
}) => !isActive && `  
      opacity: 0.5;
      pointer-events: none;
...
})(["display:flex;width:100px;height:25px;border-radius:25px;color:white;background:#bf5353;justify-content:center;align-items:center;font-family:Quicksand;font-weight:bold;border:1px solid white;border:1px solid transparent;:hover{color:#bf5353;background:white;border:1px solid #bf5353;}", ";"], ({
  isActive
}) => !isActive && `  
      opacity: 0.5;
      pointer-events: none;
...
})(["position:absolute;top:15px;right:15px;display:flex;width:fit-content;height:25px;border-radius:25px;color:white;background:", ";justify-content:center;align-items:center;font-family:Quicksand;font-weight:bold;border:1px solid white;border:1px solid transparent;:hover{color:", ";background:white;border:1px solid ", ";}"], colors.darkBlue, colors.darkBlue, colors.darkBlue);
...
})(["font-size:8px;color:red;font-family:Quicksand;font-weight:bold;margin:0;"]);
...
})(["display:flex;width:75px;height:30px;border-radius:25px;color:white;background:", ";justify-content:center;align-items:center;font-family:Quicksand;font-weight:bold;border:1px solid white;border:1px solid transparent;:hover{color:", ";background:white;border:1px solid ", ";}", ";"], colors.darkBlue, colors.darkBlue, colors.darkBlue, ({
  isActive
}) => !isActive && `  
      opacity: 0.5;
      pointer-events: none;
...
})(["font-family:Quicksand;color:", ";font-size:28px;font-weight:800;margin 0;"], colors.mainBlue);
...
})(["font-family:Quicksand;color:", ";font-size:16px;margin 0;"], colors.mainBlue);
...
})(["margin:0;display:inline-flex;width:fit-content;font-family:Quicksand;text-align:center;color:white;font-size:14px;"]);
...
})(["color:white;width:fit-content;font-family:Quicksand;margin:0;font-weight:800;display:inline-flex;font-size:33px;text-decoration:underline;text-align:center;"]);
...
})(["display:flex;flex-wrap:wrap;padding:0 15px;margin:3%;justify-items:center;row-gap:30px;background:white;padding:50px 15px;border-radius:10px;justify-content:space-around;"]);
...
})(["display:flex;position:absolute;top:", ";left:", ";right:", ";width:25px;height:25px;background:", ";color:white;border-radius:100%;border:none;font-size:22px;font-weight:bold;font-family:Quicksand;justify-content:center;align-items:center;box-shadow:1px 1px #ccc6c6;@media (max-width:500px){width:18px;height:18px;font-size:12px;}:hover{color:", ";background:white;border:1px solid ", ";}"], props => props.top, props => props.left, props => props.right, colors.darkBlue, colors.darkBlue, colors.darkBlue);
...
})(["margin:15px 0;text{font-family:Quicksand;fill:white;font-weight:bold;font-size:14px;}"]);
;// CONCATENATED MODULE: ./src/app/helpers/getManagerRating.ts
...
const SleeperDynasty = () => {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(components_Layout, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(StyledHeader, {
      ...
      children: allTeamData.map((team, index) => /*#__PURE__*/(0,jsx_runtime.jsxs)(TeamContainer, {
...
})(["margin:0;font-family:Quicksand;font-size:18px;font-weight:bold;color:white;"]);
...
})(["font-family:Quicksand;font-size:24px;color:", ";text-align:center;"], colors.darkBlue);
...
})(["font-family:Quicksand;text-align:center;font-size:40px;font-weight:bold;"]);
...
})(["border:3px solid ", ";display:flex;flex-direction:column;align-items:start;background:white;border-radius:25px;box-shadow:0px 17px 20px 8px #0000006b;@media (max-width:1000px){align-items:center;width:80%;}"], colors.darkBlue);
...
})(["font-family:Quicksand;color:black;font-weight:bold;font-size:22px;width:100%;background:", ";border-top-right-radius:22px;border-top-left-radius:22px;height:50px;display:flex;align-items:center;justify-content:center;border-bottom:1px solid ", ";"], colors.mainGray, colors.darkBlue);
...
})(["font-family:Quicksand;color:black;font-weight:normal;font-size:18px;"]);
...
})(["font-family:Quicksand;font-size:18px;font-weight:bold;"]);
...
})(["font-family:Quicksand;font-weight:bold;color:", " !important;"], ({
  color
}) => color);
...
})(["font-size:18px;font-family:Quicksand;font-weight:bold;color:", ";background:white;cursor:pointer;margin:0;border-radius:25px;border:1px solid black;", "}"], colors.darkBlue, ({
  isActive
}) => isActive && `
      background: ${colors.darkBlue};
      color: white;
...
})(["border:1px solid blue;font-family:Quicksand;font-weight:bold;width:200px;border-radius:5px;"]);
...
})(["font-family:Quicksand;font-weight:bold;color:white;font-size:30px;text-align:center;"]);
...
})(["position:absolute;top:15px;font-family:Quicksand;color:#0e7de9;font-size:25px;font-weight:bold;"]);
