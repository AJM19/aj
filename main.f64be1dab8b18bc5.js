...
const moveUpward = /*#__PURE__*/(0,styled_components_browser_cjs/* keyframes */.F4)(["from{transform:translateY(0) scale(1) perspective(500px) rotateX(30deg);}to{transform:translateY(-100vh) scale(0.2) perspective(500px) rotateX(30deg);opacity:0.1}"]);
...
const moveUpAnimation = /*#__PURE__*/(0,styled_components_browser_cjs/* css */.iv)(["", " 15s ease-out forwards;"], moveUpward);
